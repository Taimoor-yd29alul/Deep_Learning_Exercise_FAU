...
class FullyConnected(BaseLayer):  # Inherit from the base layer
    ...
    def initialize(self,weights_initializer, bias_initializer):
        print(self.input_size, self.output_size, self._weights.shape)
        self._weights= weights_initializer.initialize((self.input_size, self.output_size), self.input_size, self.output_size)
        self._weights[-1, :] = bias_initializer.initialize((1, self.output_size), self.input_size, self.output_size)
